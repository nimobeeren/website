...
To kick-start my professional career, I joined [Deity](https://deity.io/) in 2019, where I learned about all the wonders of the web. I learned React, which empowered me to build any UI we needed. I enjoyed building complex components with a focus on interactivity and responsiveness. Through building out our GraphQL API, I realized how graphs and schemas made development so much faster and more robust, especially in combination with TypeScript.
