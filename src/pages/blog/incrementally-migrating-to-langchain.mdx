...
# 		),
# 		Document(
# 				page_content="Blueberries rock.",
# 				metadata={"title": "The Berry Book"}
# 		)
# ]
```
...
- Try any retriever integration like Elasticsearch, Cohere or BM25
...
- Use any other analytics/eval integration like [Context](https://python.langchain.com/v0.2/docs/integrations/callbacks/context/) or [Confident](https://python.langchain.com/v0.2/docs/integrations/callbacks/confident/)
